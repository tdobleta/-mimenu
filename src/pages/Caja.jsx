...
export default function Caja() {
  ...
  const elapsed = turnoActivo ? Math.floor((Date.now() - (typeof turnoActivo.abiertaAt === "string" ? new Date(turnoActivo.abiertaAt).getTime() : turnoActivo.abiertaAt)) / 60000) : 0;
            ...
            <div style={{ display:'flex', alignItems:'center', gap:10, flexWrap:'wrap' }}>
              ...
              {(() => {
                ...
                if (apertura.getTime() < hoy.getTime()) {
                  return <span style={{ backgroundColor:'#FEF3C7', color:'#92600A', padding:'4px 10px', borderRadius:99, fontSize:11, fontWeight:600 }}>⚠  Turno de ayer — cerrá y abrí uno nuevo</span>;
                }
                return null;
              })()}
            </div>
                ...
                <div style={{position:'fixed',inset:0,zIndex:1000,display:'flex',alignItems:'center',justifyContent:'center',background:'rgba(15,15,35,0.5)',backdropFilter:'blur(4px)'}}>
                  <div style={{background:'white',borderRadius:18,padding:28,width:380,maxWidth:'95vw',fontFamily:"'DM Sans',system-ui,sans-serif",boxShadow:'0 24px 48px rgba(0,0,0,0.15)'}}>
                    ...
                    <div style={{fontSize:13,color:'#6B7280',textAlign:'center',lineHeight:1.6,marginBottom:20}}>
                      Cerrá todas las mesas antes de cerrar el turno. Las ventas sin cerrar no quedarán registradas en este turno.
                    </div>
